    ...
    return (
        <div className="max-w-lg border w-full mx-auto mt-[35vh] rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
          ...
          <LabelInputContainer className="mb-4">
            <Label htmlFor="email" className="lg:text-base xl:text-lg">Email Address</Label>
            <Input id="email" className="lg:text-base xl:text-lg" placeholder="projectmayhem@fc.com" type="email"  value={email} // Bind the input value to state
