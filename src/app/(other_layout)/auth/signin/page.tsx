  ...
  const handleVendor  = async () => {
    ...
    return (
        ...
        <div className=" flex justify-evenly">
            <button onClick={handleUser} className="bg-gradient-to-br p-2 relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800  text-white rounded-md">User Login</button>
            <button onClick={handleAdmin} className="bg-gradient-to-br p-2 relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800  text-white rounded-md">Admin Login</button>
            <button onClick={handleVendor} className="bg-gradient-to-br p-2 relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800  text-white rounded-md">Vendor Login</button>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className="my-8" >
          ...
          <button
            className="bg-gradient-to-br mt-3 relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium "
            type="submit"
          >
            Sign in
            <BottomGradient />
